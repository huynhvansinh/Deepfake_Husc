...
OUTPUT_DIR = "./training_outputs/densenet121_ffpp_optimized"
...
# RTX 5070 Laptop 8GB thường có thể thử 48 trước.
# Nếu OOM thì hạ về 32. Nếu còn dư VRAM thì tăng 64.
BATCH_SIZE = 32
...
def create_dataloader(dataset, batch_size, shuffle):
    ...
    # Chỉ thêm các option này khi num_workers > 0 để tránh lỗi
    if NUM_WORKERS > 0:
...
def main():
    ...
    # Tính class weights theo dataset đã lọc ảnh lỗi
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if improved:
            ...
            no_improve_epochs += 1
            print(f"Không cải thiện: {no_improve_epochs}/{EARLY_STOPPING_PATIENCE}")
        ...
        if no_improve_epochs >= EARLY_STOPPING_PATIENCE:
            print("Early stopping: dừng train do validation không cải thiện.\n")
            break
